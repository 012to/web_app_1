...
- ユーザー主体で、多角的にモチベーションアップのきっかけを共有し合うことができるアプリを作りたいと思った。
...
### ●解決方法
モチベーションが高まった行動や名言、考え方などをユーザーが共有し合う掲示板を用意する。
自分の投稿をまとめて見ることができるページ(お守り)を作り、いつでも振り返ることができるようにする。
ユーザーの嗜好に捉われない(ランダムに投稿が表示される)ルーレット機能を設け、新たなアイデアを提供することで次の前向きなアクションへと繋がる。
